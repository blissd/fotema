...
banner-detect-faces-photos = Gezichten in foto's worden gedetecteerd. Dit kan even duren.
prefs-albums-section = Albums
    .description = Configureer albums.
prefs-library-section-pictures-dir =
    .title = Afbeeldingenmap
    .tooltip = Kies de afbeeldingenmap.
banner-scan-library = Bibliotheek aan het scannen.
banner-recognize-faces-photos = Personen in foto's worden herkend. Dit kan even duren.
banner-button-stop =
    .label = Stoppen
    .tooltip = Stop alle achtergrondtaken.
