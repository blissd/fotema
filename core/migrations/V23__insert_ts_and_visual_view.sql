-- SQLite doesn't allow current_timestamp as default value when using
-- "alter table" to add a column :-(

ALTER TABLE pictures ADD COLUMN insert_ts DATETIME NOT NULL DEFAULT '1970-01-01 00:00:00';

UPDATE pictures SET insert_ts = COALESCE(
    fs_created_ts,
    fs_modified_ts,
    CURRENT_TIMESTAMP);

ALTER TABLE videos ADD COLUMN insert_ts DATETIME NOT NULL DEFAULT '1970-01-01 00:00:00';

UPDATE videos SET insert_ts = COALESCE(
    fs_created_ts,
    fs_modified_ts,
    CURRENT_TIMESTAMP);
